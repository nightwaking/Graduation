...
<body ontouchstart>
<form action="<?php echo U('User/changePassword');?>" method="post">
        <?php if(is_array($kind)): foreach($kind as $key=>$vo): ?><div class="weui-cells__title">用户名</div>
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" placeholder="请输入用户名" value="<?php echo ($vo["username"]); ?>" disabled="disabled">
                </div>
            </div>
        </div>
        <input type="text" name="username" hidden="hidden" value="<?php echo ($vo["username"]); ?>">

        <div class="weui-cells__title">旧密码</div>
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" name="old_password"  placeholder="请输入旧密码">
                </div>
            </div>
        </div>
        ...
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" name="new_password" placeholder="请输入新密码">
                </div>
            </div>
        </div>
        ...
        <div class="weui-cells">
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" name="renew_password" placeholder="请重复输入新密码">
                </div>
            </div>
